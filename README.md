...
2. Execute position_control.m in simulation mode to perform batch simulations across fixed gain and optimisation methods, producing 100 data points per scenario. [Note: Initial conditions are generated automatically via initial_position.slx during each simulation run.]
